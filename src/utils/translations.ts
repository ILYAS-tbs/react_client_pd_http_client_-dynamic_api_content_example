...
weeklyMenu: {
  ...
  filterStudentsPlaceholder: {
    ar: "تصفية الطلاب...",
    en: "Filter students...",
    fr: "Filtrer les élèves...",
  },
  classHasNoStudentsYet: {
    ar: "لا يوجد طلاب في هذا القسم حتى الآن.",
    en: "This class has no students yet.",
    fr: "Cette classe n'a pas encore d'élèves.",
  },
  noMatchingStudents: {
    ar: "لا يوجد طلاب مطابقون للبحث.",
    en: "No matching students.",
    fr: "Aucun élève correspondant.",
  },
  markAbsentForToday: {
    ar: "تسجيل غياب اليوم",
    en: "Mark absent for today",
    fr: "Marquer absent pour aujourd'hui",
  },
  markedAbsentMessage: {
    ar: "تم تسجيله غائباً.",
    en: "marked absent.",
  ...
  noDevoirSchedulesAvailable: {
    ar: "لا توجد جداول فروض متاحة حالياً",
    en: "No devoir schedules available right now",
    fr: "Aucun calendrier de devoirs disponible pour le moment",
  },
  devoirSchedules: {
    ar: "جداول الفروض",
    en: "Devoir Schedules",
    fr: "Calendriers des devoirs",
  },
  examSchedules: {
    ar: "جداول الامتحانات",
    en: "Exam Schedules",
    fr: "Calendriers des examens",
  },
  devoirAndExamsSchedules: {
    ar: "جداول الفروض والامتحانات",
    en: "Devoir & Exams Schedules",
    fr: "Calendriers des devoirs et examens",
  },
  devoirAndExams: {
    ar: "الفروض والامتحانات",
    en: "Devoir & Exams",
    fr: "Devoirs et examens",
  },
  devoirExamDashboardDescription: {
    ar: "أدر جداول الفروض والامتحانات لكل قسم مع معاينة الملفات وتحديثها فورياً.",
    en: "Manage devoir and exam schedules for each class with instant file previews and live updates.",
    fr: "Gérez les calendriers des devoirs et des examens par classe avec aperçu des fichiers et mises à jour immédiates.",
  },
  parentDevoirExamDescription: {
    ar: "اعرض جداول الفروض والامتحانات الخاصة بقسم طفلك مع معاينة الملفات مباشرة.",
    en: "View the devoir and exam schedules for your child’s class with direct file previews.",
    fr: "Consultez les calendriers des devoirs et des examens de la classe de votre enfant avec aperçu direct des fichiers.",
  },
  scheduleType: {
    ar: "نوع الجدول",
    en: "Schedule Type",
  ...
  uploadScheduleFile: {
    ar: "رفع جدول جديد",
    en: "Upload Schedule File",
    fr: "Téléverser un calendrier",
  },
  editScheduleFile: {
    ar: "تعديل الجدول",
    en: "Edit Schedule File",
    fr: "Modifier le calendrier",
  },
  scheduleTitlePlaceholder: {
    ar: "أدخل عنواناً اختيارياً للجدول",
    en: "Enter an optional schedule title",
    fr: "Saisissez un titre facultatif pour le calendrier",
  },
  pdfImagePreviewHint: {
    ar: "PDF أو صورة: JPG / JPEG / PNG / WEBP",
    en: "PDF or image: JPG / JPEG / PNG / WEBP",
    fr: "PDF ou image : JPG / JPEG / PNG / WEBP",
  },
  confirmDeleteSchedule: {
    ar: "هل تريد حذف هذا الجدول؟",
    en: "Do you want to delete this schedule?",
    fr: "Voulez-vous supprimer ce calendrier ?",
  },
  weeklyMealsProgram: {
  ...
  pdfOrImageOnlyError: {
    ar: "يسمح فقط برفع ملفات PDF أو الصور بصيغ JPG و JPEG و PNG و WEBP",
    en: "Only PDF or JPG, JPEG, PNG, and WEBP image files are allowed",
    fr: "Seuls les fichiers PDF ou les images JPG, JPEG, PNG et WEBP sont autorisés",
  },
  examCalendar: {
    ar: "رزنامة الامتحانات",
    en: "Exam Calendar",
  ...
  devoir: { ar: "فرض", en: "Devoir", fr: "Devoir" },
...
educationalMaterials: {
  ...
  controlCenterSubtitle: {
    ar: "مركز قيادة موحد لمراقبة المنصة وإدارتها",
    en: "Unified control center for monitoring and operating the platform",
    fr: "Centre de contrôle unifié pour surveiller et gérer la plateforme",
  },
  showing: {
    ar: "عرض",
    en: "Showing",
  ...
  searchActivity: {
    ar: "ابحث في السجل أو المشرف أو الكيان...",
    en: "Search logs, admin, or entity...",
    fr: "Rechercher dans les logs, admins ou entités...",
  },
  auditEntries: {
    ar: "سجلات التدقيق",
    en: "Audit entries",
  ...
  pendingInvestigations: {
    ar: "العناصر التي تحتاج متابعة",
    en: "Items needing follow-up",
    fr: "Éléments à suivre",
  },
  loadingActivity: {
  ...
  auditTrailDescription: {
    ar: "راجع كل تغييرات الإدارة وإشارات التشغيل الحرجة",
    en: "Review every admin-side change and critical operational signal",
    fr: "Passez en revue chaque modification admin et chaque signal opérationnel critique",
  },
  alertFeed: {
    ar: "موجز التنبيهات",
    en: "Alert feed",
  ...
  latestPlatformChanges: {
    ar: "أحدث التغييرات والإجراءات عبر المنصة",
    en: "Latest changes and actions across the platform",
    fr: "Derniers changements et actions sur la plateforme",
  },
  pendingQueue: {
    ar: "قائمة الانتظار الحالية",
    en: "Current queue",
    fr: "File d'attente actuelle",
  },
  expiringMemberships: {
    ar: "الاشتراكات القريبة من الانتهاء",
    en: "Expiring memberships",
    fr: "Abonnements expirant bientôt",
  },
  highPriorityAnnouncements: {
    ar: "الإعلانات عالية الأولوية",
    en: "High priority announcements",
    fr: "Annonces haute priorité",
  },
  keepCommunicationVisible: {
    ar: "راقب الرسائل التي يجب أن تبقى ظاهرة للمستخدمين",
    en: "Track messages that should remain visible to users",
    fr: "Suivez les messages qui doivent rester visibles pour les utilisateurs",
  },
  alerts: {
    ar: "التنبيهات",
    en: "Alerts",
  ...
  totalReports: {
    ar: "إجمالي التقارير",
    en: "Total reports",
    fr: "Total des rapports",
  },
  reportApprovedSuccessfully: {
    ar: "تمت الموافقة على التقرير بنجاح",
    en: "Report approved successfully",
    fr: "Rapport approuvé avec succès",
  },
  reportRejectedSuccessfully: {
    ar: "تم رفض التقرير بنجاح",
    en: "Report rejected successfully",
    fr: "Rapport rejeté avec succès",
  },
  newThisMonth: {
    ar: "الجدد هذا الشهر",
    en: "New this month",
    fr: "Nouveaux ce mois-ci",
  },
  schoolAccounts: {
    ar: "حسابات المدارس",
    en: "School accounts",
  ...
  platformAdmins: {
    ar: "مديرو المنصة",
    en: "Platform admins",
    fr: "Admins plateforme",
  },
  unattachedUsers: {
    ar: "مستخدمون بلا دور",
    en: "Unattached users",
    fr: "Utilisateurs sans rôle métier",
  },
  recentUsers: {
    ar: "أحدث المستخدمين",
    en: "Recent users",
  ...
  studentsWithParents: {
    ar: "طلاب مرتبطون بأولياء",
    en: "Students linked to parents",
    fr: "Élèves liés à des parents",
  },
  admin: {
    ar: "مشرف",
    en: "Admin",
  ...
  userManagementDescription: {
    ar: "فلترة الحسابات، مراجعة تفاصيلها، وتنفيذ إجراءات جماعية بشكل آمن",
    en: "Filter accounts, inspect their details, and run bulk actions safely",
    fr: "Filtrez les comptes, inspectez leurs détails et lancez des actions groupées en toute sécurité",
  },
  users: {
    ar: "المستخدمون",
    en: "Users",
  ...
  selectUsersForBulkActions: {
    ar: "حدد مستخدمين لتفعيل الإجراءات الجماعية",
    en: "Select users to enable bulk actions",
    fr: "Sélectionnez des utilisateurs pour activer les actions groupées",
  },
  bulkDeactivateSuccess: {
    ar: "تم تعطيل المستخدمين المحددين بنجاح",
    en: "Selected users were deactivated successfully",
    fr: "Les utilisateurs sélectionnés ont été désactivés avec succès",
  },
  bulkReactivateSuccess: {
    ar: "تمت إعادة تفعيل المستخدمين المحددين بنجاح",
    en: "Selected users were reactivated successfully",
    fr: "Les utilisateurs sélectionnés ont été réactivés avec succès",
  },
  bulkDeactivate: {
    ar: "تعطيل جماعي",
    en: "Bulk deactivate",
    fr: "Désactivation groupée",
  },
  bulkReactivate: {
    ar: "إعادة تفعيل جماعي",
    en: "Bulk reactivate",
    fr: "Réactivation groupée",
  },
  auditAction: {
    create: { ar: "إنشاء", en: "Create", fr: "Créer" },
    update: { ar: "تحديث", en: "Update", fr: "Mettre à jour" },
    approve: { ar: "موافقة", en: "Approve", fr: "Approuver" },
    reject: { ar: "رفض", en: "Reject", fr: "Rejeter" },
    publish: { ar: "نشر", en: "Publish", fr: "Publier" },
    archive: { ar: "أرشفة", en: "Archive", fr: "Archiver" },
    activate: { ar: "تفعيل", en: "Activate", fr: "Activer" },
    suspend: { ar: "إيقاف", en: "Suspend", fr: "Suspendre" },
    deactivate: { ar: "تعطيل", en: "Deactivate", fr: "Désactiver" },
    reactivate: { ar: "إعادة التفعيل", en: "Reactivate", fr: "Réactiver" },
    extend: { ar: "تمديد", en: "Extend", fr: "Prolonger" },
    cancel: { ar: "إلغاء", en: "Cancel", fr: "Annuler" },
    bulk_action: { ar: "إجراء جماعي", en: "Bulk action", fr: "Action groupée" },
    other: { ar: "أخرى", en: "Other", fr: "Autre" },
  },
  alertKey: {
    inactive_schools: { ar: "مدارس موقوفة", en: "Inactive schools", fr: "Écoles inactives" },
    inactive_users: { ar: "مستخدمون غير نشطين", en: "Inactive users", fr: "Utilisateurs inactifs" },
    unattached_non_admin_users: { ar: "مستخدمون بلا دور ولا صلاحية إدارة", en: "Unattached non-admin users", fr: "Utilisateurs sans rôle ni accès admin" },
    pending_absence_reports: { ar: "تقارير غياب معلقة", en: "Pending absence reports", fr: "Rapports d'absence en attente" },
    pending_behaviour_reports: { ar: "تقارير سلوك معلقة", en: "Pending behaviour reports", fr: "Rapports de comportement en attente" },
    expired_memberships: { ar: "اشتراكات منتهية", en: "Expired memberships", fr: "Abonnements expirés" },
    expiring_memberships: { ar: "اشتراكات تنتهي قريباً", en: "Expiring memberships", fr: "Abonnements expirant bientôt" },
    high_priority_announcements: { ar: "إعلانات عالية الأولوية", en: "High priority announcements", fr: "Annonces haute priorité" },
  },
  },
  ...
  classes: { ar: "الفصول", en: "Classes", fr: "Classes" },
  attendanceTab: { ar: "الحضور", en: "Attendance", fr: "Présences" },
  attendanceTabSubtitle: { ar: "سجل الغياب اليومي حسب القسم والفترة والمادة", en: "Track daily absences by class, date range, and module", fr: "Suivez les absences journalières par classe, période et matière" },
  ...
  teacherAbsencesTabSubtitle: { ar: "إدارة الغيابات اليومية حسب القسم والتاريخ", en: "Manage daily absences by class and date", fr: "Gérez les absences journalières par classe et date" },
  teacherAbsenceSaved: { ar: "تم حفظ الغياب", en: "Absence saved", fr: "Absence enregistrée" },
  teacherAbsenceSaveFailed: { ar: "فشل حفظ الغياب", en: "Failed to save absence", fr: "Échec de l'enregistrement de l'absence" },
  teacherMarkAbsences: { ar: "تسجيل الغيابات", en: "Mark Absences", fr: "Marquer les absences" },
  teacherAbsenceAlreadySaved: { ar: "تم تسجيل هذا الغياب مسبقاً", en: "Absence already recorded", fr: "Absence déjà enregistrée" },
  teacherAbsenceHistory: { ar: "سجل الغيابات", en: "Absence History", fr: "Historique des absences" },
  attendanceUndoSuccess: { ar: "تم التراجع عن الغياب", en: "Absence undone", fr: "Absence annulée" },
  attendanceUndoFailed: { ar: "تعذر التراجع عن الغياب", en: "Could not undo absence", fr: "Impossible d'annuler l'absence" },
  exportCsv: { ar: "تصدير CSV", en: "Export CSV", fr: "Exporter CSV" },
  saveRollCall: { ar: "حفظ النداء", en: "Save Roll Call", fr: "Enregistrer l'appel" },
  moduleClass: { ar: "القسم والمادة", en: "Class and Module", fr: "Classe et matière" },
  hour: { ar: "الحصة", en: "Hour", fr: "Heure" },
  hourLabel: { ar: "الحصة", en: "Hour", fr: "Heure" },
  searchStudent: { ar: "البحث عن طالب", en: "Search Student", fr: "Rechercher un élève" },
  searchStudentPlaceholder: { ar: "ابحث بالاسم...", en: "Search by name...", fr: "Rechercher par nom..." },
  presentRate: { ar: "نسبة الحضور", en: "Present Rate", fr: "Taux de présence" },
  absentCount: { ar: "عدد الغياب", en: "Absent Count", fr: "Nombre d'absences" },
  pendingJustifications: { ar: "تبريرات قيد المراجعة", en: "Pending Justifications", fr: "Justifications en attente" },
  rollCall: { ar: "نداء الحضور", en: "Roll Call", fr: "Appel" },
  noStudentsForSelection: { ar: "لا يوجد طلاب لهذا الاختيار", en: "No students for this selection", fr: "Aucun élève pour cette sélection" },
  attendanceAlreadySaved: { ar: "تم تسجيل هذا الغياب مسبقاً", en: "Attendance already saved", fr: "Présence déjà enregistrée" },
  ...
  optionalModule: { ar: "مادة اختيارية", en: "Optional module", fr: "Matière facultative" },
  behaviourReportText: { ar: "نص الملاحظة", en: "Behaviour Note", fr: "Note de comportement" },
  behaviourPlaceholder: { ar: "اكتب ملاحظة واضحة وقابلة للمشاركة مع الإدارة والأولياء...", en: "Write a clear note that can be shared with school staff and parents...", fr: "Rédigez une note claire pouvant être partagée avec l'administration et les parents..." },
  submitBehaviourNote: { ar: "إرسال الملاحظة", en: "Submit Note", fr: "Envoyer la note" },
  studentTimeline: { ar: "الخط الزمني للطالب", en: "Student Timeline", fr: "Chronologie de l'élève" },
  ...
  manageAbsencesSubtitle: { ar: "حدد القسم والتاريخ ثم سجّل الغياب اليومي مباشرة من قائمة الطلاب", en: "Pick a class and date, then mark daily absences directly from the student list", fr: "Choisissez une classe et une date, puis marquez les absences journalières directement depuis la liste" },
  ...
  weekHeatMap: { ar: "خريطة الغياب الأسبوعية", en: "Weekly Heat Map", fr: "Carte thermique hebdomadaire" },
  topAbsenceStudents: { ar: "أكثر الطلاب غياباً", en: "Top Absence Students", fr: "Élèves les plus absents" },
  justificationSplit: { ar: "توزيع التبريرات", en: "Justification Split", fr: "Répartition des justifications" },
  unjustified: { ar: "غير مبرر", en: "Unjustified", fr: "Non justifié" },
  moduleHour: { ar: "المادة", en: "Module", fr: "Matière" },
  absentBy: { ar: "سجل بواسطة", en: "Recorded By", fr: "Enregistré par" },
  ...
  currentSlotAbsences: { ar: "غيابات هذا اليوم", en: "Current Day Absences", fr: "Absences du jour" },
  currentDayAbsences: { ar: "غيابات هذا اليوم", en: "Current Day Absences", fr: "Absences du jour" },
  removeAbsence: { ar: "إزالة الغياب", en: "Remove Absence", fr: "Retirer l'absence" },
  fromDate: { ar: "من تاريخ", en: "From Date", fr: "Date de début" },
  toDate: { ar: "إلى تاريخ", en: "To Date", fr: "Date de fin" },
  ...
  behaviourReportsTab: { ar: "تقارير السلوك", en: "Behaviour Reports", fr: "Rapports de comportement" },
  behaviourReportsSubtitle: { ar: "عرض ومراجعة ملاحظات السلوك الحرة", en: "Review free-text behaviour reports", fr: "Consultez les rapports de comportement en texte libre" },
  printReport: { ar: "طباعة", en: "Print", fr: "Imprimer" },
  myKidsAbsencesTab: { ar: "غيابات أبنائي", en: "My Kids' Absences", fr: "Absences de mes enfants" },
  myKidsAbsencesSubtitle: { ar: "راجع الغياب وأرسل التبريرات لكل ابن", en: "Review absences and submit justifications for each child", fr: "Consultez les absences et envoyez des justifications pour chaque enfant" },
  absenceList: { ar: "قائمة الغياب", en: "Absence List", fr: "Liste des absences" },
  justificationHistory: { ar: "سجل التبريرات", en: "Justification History", fr: "Historique des justifications" },
  submitJustification: { ar: "إرسال التبرير", en: "Submit Justification", fr: "Envoyer la justification" },
  allChildren: { ar: "جميع الأبناء", en: "All Children", fr: "Tous les enfants" },
  // ─── Homework feature ────────────────────────────────────────────
  ...
  schoolHomeworkOverview: { ar: "عرض جميع الواجبات المنشورة على مستوى المؤسسة", en: "View all homework posts across the school", fr: "Voir tous les devoirs publies dans l'ecole" },
