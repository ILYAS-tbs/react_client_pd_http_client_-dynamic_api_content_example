...
const URLS = {
  get_current_school_students: `${BASE_URL}/api/student/students/get_current_school_students`,
  get_current_school_teachers: `${BASE_URL}/api/teacher/teachers/get_current_school_teachers`,
  get_current_school_class_groups: `${BASE_URL}/api/class-group/class-groups/get_current_school_class_groups`,
};
